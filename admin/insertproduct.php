...
<body><form action="addproduct.php" method="post" enctype="multipart/form-data">
  <table width="800" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="244" align="center" valign="middle">ข้อมูลสินค้า</td>
      <td width="550" align="center" valign="middle"><a href="admindetail.php">กลับสู่หน้าหลัก</a></td>
    </tr>
    <tr>
      <td>รหัสสินค้า</td>
